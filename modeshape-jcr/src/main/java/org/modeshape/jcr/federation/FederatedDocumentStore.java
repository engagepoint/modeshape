...
public class FederatedDocumentStore implements DocumentStore {
    ...
    public String newDocumentKey(String parentKey,
        ...
        if (isParentUnfiled) connector = getUnfiledConnectorForType(documentPrimaryType);
        if (connector != null) {
    ...
    public SchematicEntry storeDocument(String key,
                                        Document document) {
        boolean isParentUnfiled = isSystemUnfiled(key);
    ...
    public SchematicEntry get(String key, boolean useChildrenCache) {
        ...
        if (connector != null) {
            ...
            Document document = connector.getDocumentById(docId, useChildrenCache);
            if (document != null) {
